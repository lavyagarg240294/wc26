...
- **Stats** (Overview · Players · Teams · Rankings) — a tournament **overview**, the **Golden Boot** & **assists** races, **goalkeepers/clean sheets**, a stack of **team leaderboards** (pass accuracy, defensive actions, crosses, saves…), per-team **playing-style fingerprints** (with a per-metric explainer), a **suspension watch** and **fair-play** table, **records** (biggest win, fastest/latest goal…), a **player head-to-head** compare, a **confederation** breakdown, and the **complete FIFA world ranking** (all 211 teams, filterable to the 48 finalists, by confederation).
