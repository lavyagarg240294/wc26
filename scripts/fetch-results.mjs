...
async function fromFifa(prev, needsPhotos) {
  ...
  for (const { f, x, entry, swap } of needLive) {
    ...
    try {
      ...
      if (lv.Period != null) entry.per = lv.Period;   // FIFA live-object period: 3 first half · 4 HT · 5 SECOND half · 7/8/9 extra-time · 10/11 shootout — the client's authoritative phase signal (no elapsed-time guessing). NB 5 = 2nd half, not ET.
