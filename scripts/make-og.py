...
tag = f(FR, 31)
d.text((x, 424), "All 104 matches in your timezone — live scores,", font=tag, fill=(200, 212, 218))
d.text((x, 464), "group tables, squads & a bracket that fills itself.", font=tag, fill=(200, 212, 218))
d.rectangle([x, 536, x + 320, 539], fill=(232, 185, 49))
d.text((x, 552), "104 MATCHES    ·    48 TEAMS    ·    16 HOST CITIES", font=f(FB, 24), fill=(150, 166, 176))
