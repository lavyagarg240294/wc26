...
tag = f(FR, 31)
d.text((x, 424), "Live scores, group tables, full 48-team squads,", font=tag, fill=(200, 212, 218))
d.text((x, 464), "and a bracket that fills itself.", font=tag, fill=(200, 212, 218))
