...
tag = f(FR, 31)
d.text((x, 424), "Live scores, lineups & match stats, group tables, the", font=tag, fill=(200, 212, 218))
d.text((x, 464), "Golden Boot race & a bracket you can call to the champion.", font=tag, fill=(200, 212, 218))
