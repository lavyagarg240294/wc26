...
tag = f(FR, 31)
d.text((x, 424), "Live scores & lineups, group tables, the Golden Boot", font=tag, fill=(200, 212, 218))
d.text((x, 464), "race & a bracket predictor you call to the champion.", font=tag, fill=(200, 212, 218))
